...
theme.Search = (function() {
  ...
  function init() {
    ...
    $('.site-header__search-toggle').on('click', function() {
      ...
      var searchOffset = $(selectors.siteHeader).offset().top - searchHeight - 35; //35px for announcement bar
  ...
  Product.prototype = _.assignIn({}, Product.prototype, {
    ...
    _initVariants: function() {
      ...
      if (this.variants.currentVariant) {
        var form = jQuery(this.selectors.addToCart).closest('form');
        for (var i=0,length=this.variants.currentVariant.options.length; i<length; i++) {
          var radioButton = form.find('.swatch[data-option-index="' + i + '"] :radio[value="' + this.variants.currentVariant.options[i] +'"]');
          if (radioButton.size()) {
