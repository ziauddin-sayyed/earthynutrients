...
var ajaxCart = (function(module, $) {
  ...
  // Quick Add
  var quickAdd = $('.product-card__quick-add');

  quickAdd.click(function(evt){
    evt.preventDefault();

    var quickAdd = jQuery.post('/cart/add.js', {
      quantity: 1,
      id: $(this).data('id')
    }).always(function(){
      ShopifyAPI.getCart(cartUpdateCallback);
...
$(function(){
  ...
  theme.MobileDrawer = new theme.Drawers('shopify-section-mobile-menu', 'right', {})

  theme.CartDrawer = new theme.Drawers('shopify-section-cart-menu', 'right', {
    onDrawerOpen: ajaxCart.load,
  })

  var $mobileNav = $('.js-mobile-nav-toggle')
  var $mobileNavClose = $('.js-mobile-nav-close')
  var $cartNav = $('.js-cart-nav-toggle')
  var $menuDrawer = $('#MenuDrawer');
  var $cartDrawer = $('#CartDrawer');

  //$mobileNav.on('click', theme.MobileDrawer.open.bind(theme.MobileDrawer));

  //$mobileNavClose.on('click', theme.MobileDrawer.close.bind(theme.MobileDrawer));

  $cartNav.on('click', theme.CartDrawer.open.bind(theme.CartDrawer))

  //show appropriate drawer content
